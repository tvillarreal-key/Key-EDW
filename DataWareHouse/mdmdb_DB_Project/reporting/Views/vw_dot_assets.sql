/****** Object:  View [reporting].[vw_dot_assets]    Script Date: 1/5/2024 3:31:13 PM ******/
SET ANSI_NULLS ON
GO
...
SELECT asset_id, asset_num, asset_desc, asset_class, manufacturer, model, model_year, 
        ...
        dist_name, mare_code, mare_name, yard_code, yard_name, tire_size, tire_size2, license_plate, number_of_axles, fifth_wheel, 
