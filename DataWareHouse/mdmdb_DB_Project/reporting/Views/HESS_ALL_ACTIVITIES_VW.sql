...
DROP VIEW IF EXISTS [reporting].[HESS_ALL_ACTIVITIES_VW];
...
, ALL_ACTIVITIES AS (
    /* BUILD THE FINAL TABLE TO ALL ACTIVITIES IN NPT REPORT */
    SELECT 
        A.JOBNUMBER,
        RIG,
        RIGTYPE,
    ...
    WHERE EXCEPTIONS_CNT = 1 -- THIS REMOVES ANY DUPLICATE ACTIVITY NUMBERS
)
