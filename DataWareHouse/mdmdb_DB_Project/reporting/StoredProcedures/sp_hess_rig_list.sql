...
CASE 
        ...
        CASE 
            WHEN ASSETNUM IN ('0006008', '0006098') THEN '5-Day'
            WHEN ASSETNUM NOT IN ('0006008', '0006098') AND DAYLIGHT24HR = 'Daylight' THEN '7-Day'
            ELSE '24-Hour' END AS RIGSUBTYPE,
        DATE AS OPDATE
...
, MINDATE AS (
    ...
    FROM HESS_RIGS
    GROUP BY RIG, RIGTYPE, RIGSUBTYPE
)
...
, BACKFILL_DATES AS (
    ...
    SELECT 
        ...
        CASE 
            WHEN M.RIG = '0086063' AND L.ALLDATES >= '2024-01-01' AND L.ALLDATES < '2024-06-14' THEN '24-Hour' 
            WHEN M.RIG = '0086063' AND L.ALLDATES >= '2024-06-14' THEN '7-Day' 
            ELSE M.RIGSUBTYPE END AS RIGSUBTYPE,
