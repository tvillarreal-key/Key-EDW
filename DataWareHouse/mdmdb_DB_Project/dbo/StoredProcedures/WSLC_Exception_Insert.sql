...
CREATE PROCEDURE [dbo].[WSLC_Exception_Insert]
AS
BEGIN
    ...
    TRUNCATE TABLE dbo.IScout_WSLC_Exceptions;

    INSERT INTO dbo.IScout_WSLC_Exceptions (FORM_ID, REPORT, EIN, FIRST_NAME, LAST_NAME, LOB_CODE, JOB_CODE, JOB_FAMILY, MP_CODE, MP_NAME, LCO_CODE, LCO_NAME)
