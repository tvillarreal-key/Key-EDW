...
CREATE NONCLUSTERED INDEX [idx_KeyView_Job_Job_ID]
    ON [dbo].[KeyView_Job]([Job_ID] ASC);
GO


CREATE NONCLUSTERED INDEX [IX_DBO_KeyView_Job]
    ON [dbo].[KeyView_Job]([CUSTOMER_JOB_ID] ASC)
