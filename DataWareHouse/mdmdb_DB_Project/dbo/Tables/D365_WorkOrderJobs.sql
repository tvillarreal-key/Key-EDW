CREATE TABLE [dbo].[D365_WorkOrderJobs] (
    ...
    CONSTRAINT [PK_D365_WorkOrderJobs] PRIMARY KEY CLUSTERED ([WORKORDERID] ASC, [LINENUMBER] ASC)
);
GO

ALTER TABLE [dbo].[D365_WorkOrderJobs]
    ADD CONSTRAINT [PK_D365_WorkOrderJobs] PRIMARY KEY CLUSTERED ([WORKORDERID] ASC, [LINENUMBER] ASC);
GO
