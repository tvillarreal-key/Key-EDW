CREATE TABLE [dbo].[D365_WorkOrders_History] (
...
ALTER TABLE [dbo].[D365_WorkOrders_History]
    ADD CONSTRAINT [PK_D365_WorkOrders_History] PRIMARY KEY CLUSTERED ([WORKORDERID] ASC);
GO
