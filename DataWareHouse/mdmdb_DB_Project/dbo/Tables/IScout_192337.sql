CREATE TABLE [dbo].[IScout_192337] (
    ...
    [S049_List_Third_Party_Equip_Inspected] NVARCHAR (64)   NULL,
    [S050_Critical_Activities_JSA_Checked]  NVARCHAR (64)   NULL,
    [S051_CA_Description]                   NVARCHAR (512)  NULL,
    [S052_Critical_Activities]              NVARCHAR (512)  NULL,
    ...
    [S116_Crew_Assigned_Position_1]         NVARCHAR (128)  NULL,
    [S117_Crew_Assigned_Position_1_Name]    NVARCHAR (128)  NULL,
    [S118_Crew_Assigned_Position_1_Sig]     NVARCHAR (64)   NULL,
