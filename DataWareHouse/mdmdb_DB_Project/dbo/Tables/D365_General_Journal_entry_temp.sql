...
GO
CREATE TABLE [dbo].[D365_General_Journal_entry_temp](
...
GO
ALTER TABLE [dbo].[D365_General_Journal_entry_temp] ADD  CONSTRAINT [PK_D365_General_Journal_entry_temp] PRIMARY KEY CLUSTERED 
(
...
CREATE NONCLUSTERED INDEX [IDX_D365_General_Journal_entry_temp_GL_ACCOUNT] ON [dbo].[D365_General_Journal_entry_temp]
(
	[GL_ACCOUNT] ASC
)WITH (STATISTICS_NORECOMPUTE = OFF, DROP_EXISTING = OFF, ONLINE = OFF, OPTIMIZE_FOR_SEQUENTIAL_KEY = OFF) ON [PRIMARY]
GO

CREATE NONCLUSTERED INDEX [IDX_D365_General_Journal_entry_temp_LEDGERACCOUNT] ON [dbo].[D365_General_Journal_entry_temp]
(
	[LEDGERACCOUNT] ASC
)WITH (STATISTICS_NORECOMPUTE = OFF, DROP_EXISTING = OFF, ONLINE = OFF, OPTIMIZE_FOR_SEQUENTIAL_KEY = OFF) ON [PRIMARY]
GO

CREATE NONCLUSTERED INDEX [IDX_D365_General_Journal_entry_temp_VOUCHER] ON [dbo].[D365_General_Journal_entry_temp]
(
	[VOUCHER] ASC
)WITH (STATISTICS_NORECOMPUTE = OFF, DROP_EXISTING = OFF, ONLINE = OFF, OPTIMIZE_FOR_SEQUENTIAL_KEY = OFF) ON [PRIMARY]
GO

CREATE NONCLUSTERED INDEX [IDX_D365_General_Journal_entry_temp_FN_LOC] ON [dbo].[D365_General_Journal_entry_temp]
(
	[FN_LOC] ASC
)WITH (STATISTICS_NORECOMPUTE = OFF, DROP_EXISTING = OFF, ONLINE = OFF, OPTIMIZE_FOR_SEQUENTIAL_KEY = OFF) ON [PRIMARY]
GO
