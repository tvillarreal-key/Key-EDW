--DROP VIEW [dbo].[GL_DATA_VIEW_NEW]
CREATE VIEW [dbo].[GL_DATA_VIEW_DEV]
AS
SELECT  
       GL.[JOURNALNUMBER]
      ,GL.[VOUCHER]
  ...
  FROM [dbo].[D365_General_Journal_entry] GL 
	   ...
	   LEFT OUTER JOIN [dbo].[D365_KES_Vend_Trans] VT ON CAST(GL.[VOUCHER] AS VARCHAR) = CAST(VT.[VOUCHER] AS VARCHAR)
--where CAST(GL.[VOUCHER] AS VARCHAR) = 'KE-API-0015457'
GO
