...
GO
DROP TABLE IF EXISTS [dataquality].[MDM_Assets_DQ] 
GO
CREATE TABLE [dataquality].[MDM_Assets_DQ](
...
SET ANSI_PADDING ON
GO
ALTER TABLE [dataquality].[MDM_Assets_DQ] ADD  CONSTRAINT [PK_MDM_Assets_DQ] PRIMARY KEY NONCLUSTERED 
(
	[AssetsHash] ASC
