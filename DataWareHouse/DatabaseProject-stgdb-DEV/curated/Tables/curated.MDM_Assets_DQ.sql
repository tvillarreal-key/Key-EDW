...
GO
DROP TABLE IF EXISTS [curated].[MDM_Assets_DQ] 
GO
CREATE TABLE [curated].[MDM_Assets_DQ](
...
SET ANSI_PADDING ON
GO
ALTER TABLE [curated].[MDM_Assets_DQ] ADD  CONSTRAINT [PK_MDM_Assets_DQ] PRIMARY KEY NONCLUSTERED 
(
	[Asset_Num] ASC,
	[LoadDate] ASC
