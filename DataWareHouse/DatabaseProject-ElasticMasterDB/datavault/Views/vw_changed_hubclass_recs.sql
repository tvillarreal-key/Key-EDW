...
-- EXTERNAL VIEW
--USE ElasticMasterDB;
DROP VIEW IF EXISTS [datavault].[vw_changed_hub_AssetClass_recs] 
GO
-- EXTERNAL VIEW
--USE ElasticMasterDB;
CREATE VIEW [datavault].[vw_changed_hub_AssetClass_recs] AS
SELECT 
    A.[AssetsHashKey]
    ,A.[LoadDate]
    ,A.[SourceSystem]
...
LEFT JOIN [datavault].[hub_AssetClass] B
...
--USE ElasticMasterDB;
SELECT *
FROM [datavault].[vw_changed_hub_AssetClass_recs]
;
