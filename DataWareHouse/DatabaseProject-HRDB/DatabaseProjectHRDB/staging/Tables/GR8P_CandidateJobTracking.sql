CREATE TABLE [staging].[GR8P_CandidateJobTracking] (
    [JobID]                          INT           NOT NULL,
    ...
    [Employer_Resized]               AS            (substring([Employer],(1),(150))) PERSISTED,
    [PrevPositionTitle_Resized]      AS            (substring([PrevPositionTitle],(1),(200))) PERSISTED
);
